...
import com.leckbrito.cursomc.domain.PagamentoComCartao;
...
import com.leckbrito.cursomc.repositories.CidadeRepository;
...
import com.leckbrito.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {		
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "alexander.diasbrito@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123") );		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "alexander@voeit.com.br", "31014113008", TipoCliente.PESSOAFISICA, pe.encode("123") );
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27468723", "93235391"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Churix", "2106", null, "Centro", "38777012", cli2, c2);
